...
class PlanFootstepsState extends State<WalkOverTerrainStateMachineBehavior.WalkOverTerrainState>
{
   ...
   private final AtomicReference<FramePose> goalPose = new AtomicReference<FramePose>(null);
